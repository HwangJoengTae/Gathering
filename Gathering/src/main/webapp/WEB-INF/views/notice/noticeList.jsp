					...
					<tbody class="listData">
						<c:forEach var="list" items="${noticeList}">
							<tr style="cursor: pointer"
								onclick="location.href='/notice/noticeDetail?notice_seq=${list.notice_seq}'">
								<td style="text-align: center">${list.notice_seq}</td>
								<td scope="col" style="text-align: center">${list.title}</td>
								<td scope="col" style="text-align: center"><fmt:formatDate
										value="${list.regdate}" type="date" /></td>
