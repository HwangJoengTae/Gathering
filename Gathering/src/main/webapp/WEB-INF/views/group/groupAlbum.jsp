	...
	<div class="container-fluid">
		<div class="row">
				...
				<div class="position-sticky pt-3">
					<ul class="nav flex-column">
						<li class="nav-item"><a class="nav-link active"
							aria-current="page"
							href="/group/groupDetail?group_seq=${albumVO.group_seq}"> <span
								data-feather="home"></span> 모임상세
						</a></li>
						<li class="nav-item"><a class="nav-link"
							href="/group/groupNoticeListView?group_seq=${albumVO.group_seq}">
								<span data-feather="file"></span> 모임공지
						</a></li>
						<li class="nav-item"><a class="nav-link"
							href="/group/groupAlbum?group_seq=${albumVO.group_seq}"> <span
								data-feather="shopping-cart"></span> 모임앨범
						</a></li>
						<li class="nav-item"><a class="nav-link"
							href="/group/groupSuda?group_seq=${albumVO.group_seq}"> <span
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				...
				<h2 style="padding-top: 5%">${group.group_name}앨범</h2>
							...
							<div class="col mb-5">
									...
									<div class="card h-100">
										...
										<div class="card-body p-3">
											...
											<button type="button" class="btn btn-outline-primary" class="fromCenter"onclick="window.open('/group/albumDetail?group_album_seq=${album.group_album_seq}&group_seq=${album.group_seq}','ㅋㅋ','width=20,heigth=20')">
											댓글 입력</button>

											</div>
											<div class="text-center mt-3">
											<c:if test="${album.reply_count ne 0}">
											<small ><b><i class="bi bi-chat-square-dots"></i>&nbsp;[&nbsp;<c:out value="${album.reply_count}"/>&nbsp;]</b></small>
											</c:if>
											</div>
